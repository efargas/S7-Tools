...
/// </summary>
public partial class MemoryDumpViewerViewModel : ViewModelBase, IDisposable
{
    private readonly MemoryDumpOrchestrator _orchestrator;
    private readonly ILogger<MemoryDumpViewerViewModel> _logger;
    ...
    /// </summary>
    public MemoryDumpViewerViewModel(
        MemoryDumpOrchestrator orchestrator,
        ILogger<MemoryDumpViewerViewModel> logger)
    {
