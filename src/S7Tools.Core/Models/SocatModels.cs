...
namespace S7Tools.Core.Models
{
    ...
    {
        public SocatProcessInfo ProcessInfo { get; set; } = new();
    ...
    public class SocatProcessInfo
    {
        ...
        public SocatTransferStats TransferStats { get; set; } = new();
        public S7Tools.Core.Models.SocatConfiguration? Configuration { get; set; }
        public S7Tools.Core.Models.SocatProfile? Profile { get; set; }
        public string? CommandLine { get; set; }
        public DateTime StartTime { get; set; }
        public SocatProcessStatus Status { get; set; }
