...
status: "current"
tags: ["pattern", "performance", "startup", "parallelization", "resource-management"]
related:
...
**Core**:
- `src/S7Tools/Services/ResourceCoordinator.cs` - Resource coordination service
...
**Usage Examples**:
- `src/S7Tools/ViewModels/Jobs/JobExecutionViewModel.cs` - Resource acquisition for job execution
- `src/S7Tools/ViewModels/Bootloader/BootloaderViewModel.cs` - Resource coordination for bootloader tasks
