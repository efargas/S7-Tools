...
- `src/S7Tools/Services/ConnectionsService.cs` - Network port management
- `src/S7Tools/Services/Tasking/JobSchedulerService.cs` - Job scheduling operations
- `src/S7Tools/Services/Bootloader/BootloaderService.cs` - Bootloader coordination
