...
**Key Files**:
- `src/S7Tools.Core/Models/Jobs/MemoryRegionProfile.cs` - Domain model
...
**Key Files**:
- `src/S7Tools/Services/AvaloniaUIThreadService.cs` - Implementation
...
**Key Files**:
- `src/S7Tools/Services/Tasking/ResourceCoordinator.cs` - Implementation
...
**Key Files**:
- `src/S7Tools.Core/Models/Jobs/TaskExecution.cs`
...
- `src/S7Tools.Core/Constants/SettingKeys.cs` - Schema constants
