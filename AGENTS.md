...
3. **Scan Pattern Catalog** (10 seconds) - Know available patterns
   - → [`docs/patterns/_index.md`](docs/patterns/_index.md)
...
| Need | File | Purpose |
|------|------|---------|
| **Master Index** | [`docs/INDEX.md`](docs/INDEX.md) | All documentation entry point |
| **System Architecture** | [`docs/architecture/overview.md`](docs/architecture/overview.md) | Clean Architecture + MVVM |
| **Pattern Catalog** | [`docs/patterns/_index.md`](docs/patterns/_index.md) | All implementation patterns |
| **Profile Management** | [`docs/patterns/profile-management.md`](docs/patterns/profile-management.md) | Unified profile pattern |
| **Semaphore Safety** | [`docs/patterns/internal-method.md`](docs/patterns/internal-method.md) | Deadlock prevention |
| **Development Workflow** | [`docs/guides/development-workflow.md`](docs/guides/development-workflow.md) | Daily commands & workflow |
| **Latest Review** | [`docs/reviews/LATEST.md`](docs/reviews/LATEST.md) | Current quality baseline |
...
1. **Start with the Master Index** — Read [`docs/INDEX.md`](docs/INDEX.md) to understand documentation structure
2. **Read Core Architecture** — [`docs/architecture/overview.md`](docs/architecture/overview.md) is the single source of truth for system design
3. **Use ONLY terminal commands** — Never use VS Code tasks for build, test, format, or run operations
4. **Reference patterns as needed** — Check [`docs/patterns/_index.md`](docs/patterns/_index.md) for implementation patterns
...
- **Master Index**: [`docs/INDEX.md`](docs/INDEX.md) - Entry point for all documentation
- **Architecture**: [`docs/architecture/`](docs/architecture/) - System design and decisions
- **Patterns**: [`docs/patterns/`](docs/patterns/) - All implementation patterns and examples
- **Guides**: [`docs/guides/`](docs/guides/) - Development workflows and guides
- **Latest Review**: [`docs/reviews/LATEST.md`](docs/reviews/LATEST.md) - Current quality baseline
- **Templates**: [`docs/templates/`](docs/templates/) - Code and documentation templates
...
- [_Index](docs/patterns/_index.md)
- [Internal Method](docs/patterns/internal-method.md)
- [Profile Management](docs/patterns/profile-management.md)
- [2025 11 10 Quality Improvements](docs/reviews/2025-11-10-quality-improvements.md)
- [Latest](docs/reviews/LATEST.md)
